...
class TestKimiCodingRouting:
    def test_kimi_coding_stays_chat_completions(self):
        assert determine_api_mode("kimi-coding", "https://api.kimi.com/coding/v1") == "chat_completions"
